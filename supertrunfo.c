...
int main() {
    ...
    scanf("%lu", &populacao1);//recebendo a populacao da cidade da carta 1, informando numeros inteiros
    ...
    float inverso_densidade_populacional1 = 1 / densidade_populacional1; //calculando o inverso da densidade populacional da carta 1
    float superpoder1 = populacao1 + area1 + pib1 + numero_pontos_turisticos1 + pib_per_capita1 + inverso_densidade_populacional1; //calculando o superpoder da carta 1
    ...
    printf("Digite a população: \n");
    scanf("%lu", &populacao2);//recebendo a populacao da cidade da carta 2, informando numeros inteiros
    printf("Digite a área (em km²): \n");
    ...
    float inverso_densidade_populacional2 = 1 / densidade_populacional2; //calculando o inverso da densidade populacional da carta 2
    float superpoder2 = populacao2 + area2 + pib2 + numero_pontos_turisticos2 + pib_per_capita2 + inverso_densidade_populacional2; //calculando o superpoder da carta 2
